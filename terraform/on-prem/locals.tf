locals {
  ...
  argocd_apps_all = {
    ...
    "resources-addons"    = var.argocd_files_config.load_resources && local.gitops_addons_private_url == "" ? file("${path.module}/../../bootstrap/hub/resources-addons.yaml") : ""
    "resources-workloads" = var.argocd_files_config.load_resources && local.gitops_workloads_private_url == "" ? file("${path.module}/../../bootstrap/hub/resources-workloads.yaml") : ""
  }
